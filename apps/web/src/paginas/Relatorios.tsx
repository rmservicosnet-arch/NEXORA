...
const GRUPOS: readonly Grupo[] = [
  {
    ...
    itens: [
      ...
      { nome: 'Saldo negativo', descricao: 'O que está abaixo de zero, e desde quando' },
      { nome: 'Abaixo do mínimo', descricao: 'O que repor, pelo saldo disponível' },
      {
        nome: 'Razão de movimentações',
        descricao: 'Todo entra e sai, com saldo e custo',
        para: '/estoque',
      },
      { nome: 'Curva ABC', descricao: 'Os 20% de itens que concentram o valor', restrito: true },
      {
        nome: 'Giro e cobertura',
        descricao: 'Quantas vezes girou, quantos dias cobre',
        restrito: true,
      },
      { nome: 'Sem movimento', descricao: 'Encalhe: dinheiro parado há N dias', restrito: true },
      { nome: 'Divergências de inventário', descricao: 'Contado contra sistema' },
      { nome: 'Transferências', descricao: 'Enviado, recebido, em trânsito' },
    ],
  },
  {
    nome: 'Vendas',
